...
public class Add_Employee extends JFrame implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon("C:\\Users\\dev\\Documents\\NetBeansProjects\\Employee_Management_system\\src\\icons\\add_employee.jpg");
        id15.setIcon(img);
        add(id15);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn cc = new conn();
                String q = "insert into employee values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+
                        "','"+i+"','"+j+"','"+k+"');";
