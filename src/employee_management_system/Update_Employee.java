...
public class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        f.setLayout(null);
        f.setBounds(280,50,900,500);
        
        id_emp=idaa;
        id15 = new JLabel();
        id15.setBounds(0,0,900,500);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon("src/icons/add_employee.jpg");
        id15.setIcon(img);
        f.add(id15);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
           try{
               conn con = new conn();
               String str = "update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+
                       "',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',post='"+t7.getText()+"',aadhar='"+t8.getText()+
                       "',emp_id='"+t9.getText()+"' where emp_id='"+id_emp+"';";
    ...
    public static void main(String args[]){
     Update_Employee emp1 = new Update_Employee("update");
    }
}
