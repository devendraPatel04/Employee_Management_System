...
public class Print_Data extends JFrame implements ActionListener{
    ...
    Print_Data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img = new ImageIcon("src/icons/print.jpg");
        id9.setIcon(img);
        add(id9);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            JOptionPane.showMessageDialog(null,"printed successfull");
            setVisible(false);
    ...
    public static void main(String args[]){
        new Print_Data("print").setVisible(true);
    }
}
